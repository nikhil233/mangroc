...
<div class=" pt-95 pb-100 shoping-cart spad">
            <div class="container">
						...
						<div class="shoping__cart__table">
                                ...
                                <table>
                                    ...
                                    <tbody>
										...
										<tr>
                                            <td>
											<a href="<?php echo FRONT_SITE_PATH.'order_detail.php?id='.$row['id']?>"><div class="div_order_id"><?php echo $row['id']?></div></a>
											
											<br/>
											<a href="<?php echo FRONT_SITE_PATH?>download_invoice.php?id=<?php echo $row['id']?>"><img src='<?php echo FRONT_SITE_PATH?>img/icon-img/pdf.png' width="20px" title="Download Invoice"/></a>
											</td>
